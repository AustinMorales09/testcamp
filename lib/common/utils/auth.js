...
const renderSignUpEmail = _loopback.default.template(_path.default.join(__dirname, '..', '..', 'server', 'views', 'emails', 'user-request-sign-up.ejs'));
exports.renderSignUpEmail = renderSignUpEmail;
const renderSignInEmail = _loopback.default.template(_path.default.join(__dirname, '..', '..', 'server', 'views', 'emails', 'user-request-sign-in.ejs'));
exports.renderSignInEmail = renderSignInEmail;
const renderEmailChangeEmail = _loopback.default.template(_path.default.join(__dirname, '..', '..', 'server', 'views', 'emails', 'user-request-update-email.ejs'));
exports.renderEmailChangeEmail = renderEmailChangeEmail;
